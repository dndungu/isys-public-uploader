			...
			<form method="POST" id="isys_visitor_post_form">
				...
				<label class="attachments">
					...
					<span class="field">
						...
						<?php }else{?>
						<iframe id="iframeuploader" frameborder="0" name="iframeuploader" style="border:0 none;height:30px;width:100%;overflow:hidden;" src="/wp-content/plugins/isys-public-uploader/uploader.php"></iframe>
						<?php }?>
