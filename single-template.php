					...
					<?php while(have_posts()){?>
						...
						<div id="comments" style="padding:0 0 0 40px;font-family: Gill Sans W02,Arial,sans-serif;">
							...
							<form method="POST" id="isys_visitor_comment_form">
								...
								<label>
									<textarea rows="3" cols="12" name="comment_content" onblur="if (this.value == '') { this.value = '<?php print isys_visitor_posts::translate('enter-comment')?>';}" onfocus="if (this.value == '<?php print isys_visitor_posts::translate('enter-comment')?>'){this.value = '';}"><?php print isys_visitor_posts::translate('enter-comment')?></textarea>
								</label>
